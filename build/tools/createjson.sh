...
existingOTAjson=./vendor/OTA_update/$1.json
output=$2/$1.json
...
if [ -f $existingOTAjson ]; then
	...
	download="https://sourceforge.net/projects/malluos/files/'$device'/'$4'/download"
	...
	"response": [
		{
			...
			"device": "'$device'",
			"filename": "'$filename'",
			"download": "https://sourceforge.net/projects/malluos/files/'$1'/'$3'/download",
			"timestamp": '$timestamp',
			"md5": "'$md5'",
			"size": '$size',
			"version": "'$version'",
	...
	echo 'Consider adding official support by reading the documentation at https://github.com/MalluOS/OTA_update/blob/thegga-10/README.md' >> $output;
fi
