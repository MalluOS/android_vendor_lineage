...
MALLUOS_BUILDTYPE ?= UNOFFICIAL
MALLUOS_VERSION := BETA

LINEAGE_VERSION := MalluOS-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(MALLUOS_VERSION)-$(shell date +%Y%m%d)-$(LINEAGE_BUILD)-$(MALLUOS_BUILDTYPE)
LINEAGE_DISPLAY_VERSION := MalluOS-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(MALLUOS_VERSION)-$(LINEAGE_BUILD)-$(MALLUOS_BUILDTYPE)
