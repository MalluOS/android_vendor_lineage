...
LINEAGE_VERSION := MalluOS-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(shell date +%Y%m%d)-$(LINEAGE_BUILD)-$(MALLUOS_BUILDTYPE)
LINEAGE_DISPLAY_VERSION := MalluOS-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(LINEAGE_BUILD)-$(MALLUOS_BUILDTYPE)
